...
{
	/* Custom inspector for the GeneralHeatmap class */
	[CustomEditor(typeof(GeneralHeatmap), true)]
	public class GeneralHeatmapInspector : Editor
	{
		/** The heatmap */
		protected GeneralHeatmap heatmap;

		/** Unity OnEnable method */
		void OnEnable()
		{
			//TODO maybee use SerializedProperty
			heatmap = (GeneralHeatmap)target;
		}
